...
public class GameAnalyticsHome extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("友盟统计(游戏场景)");
        setContentView(R.layout.umeng_example_game);
        mContext = this;
    ...
    public void onButtonClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.umeng_example_analytics_game_bonus:
                ...
                break;
            case R.id.umeng_example_analytics_game_signinDefalut:
                // 用户登录
                UMGameAgent.onProfileSignIn("example_id");
                break;
            case R.id.umeng_example_analytics_game_signin:
                // 用户登录
                UMGameAgent.onProfileSignIn("example_id", "UID");
                break;
            ...
            case R.id.setLevelSecond:
                UMGameAgent.setPlayerLevel(11);
                break;
            default:
                break;
        }
